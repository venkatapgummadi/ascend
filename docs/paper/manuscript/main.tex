...
\item \textit{Empirical evaluation.} A within-subjects pre/post study across twelve enterprise repositories and three organizations over 26 weeks, with paired statistical tests, $95$~percent confidence intervals, and effect-size interpretation for all primary metrics (Section~\ref{sec:eval}).
\end{enumerate}
